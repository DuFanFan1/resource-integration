     ...
     return (
       <Card>
            ...
            >
              ...
              {/* <Input placeholder={this.state.r_name}  {...getFieldProps('r_name')} value={this.state.resource.r_name} onChange={this.InputRnameChange.bind(this)}/> */}
            </FormItem>
            <FormItem
              label="资源描述"
              labelCol={{ span: 4 }}
            ...
            >
              {/* <TextArea {...getFieldProps('r_desc') } rows={4} value={this.state.r_desc} onChange={this.InputRdescChange.bind(this)}/> */}
            ...
            >
              ...
              {/* <FormItem
                ...
                hasFeedback
              >
                <Select {...getFieldProps('rtype') } value={this.state.rtype} onChange={this.SelectRtype2Change.bind(this)}>
              ...
              <span> <Button style={buttoncolor} size="large" onClick={this.putdata.bind(this)}>保存</Button></span>
